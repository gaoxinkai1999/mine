...
module.exports = {
  // --- Web 相关 ---
  webVersion: "1.3.9", // 当前最新的 Web 版本 (发布新 Web 版本时修改这里)
  ...
  // --- (可选) 更新说明 ---
  // 每次发布时可以更新这些说明
  webReleaseNotes: "1.Fixed product deletion 2.Sort order items by category",
  nativeReleaseNotes: "Improved stability and user experience"
};
